...
- **Project Structure**:
    - `src/wildcamtools/lib`: Core buisness logic (motion, rtsp, segments, etc.).
    - `src/wildcamtools/cli`: CLI tool implementation. Avoid adding buisness logic here, try to keep it to only code related to the CLI.
